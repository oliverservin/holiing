            ...
            window.customToastHTML = `
                <div class='relative flex items-start justify-center p-4'>
                    ...
                    <div class='flex flex-col'>
                        <p class='text-sm font-medium text-zinc-800'>New Friend Request</p>
                        <p class='mt-1 text-xs leading-none text-zinc-800'>Friend request from John Doe.</p>
                        <div class='flex mt-3'>
                            <button type='button' @click='burnToast(toast.id)' class='inline-flex items-center px-2 py-1 text-xs font-semibold text-white bg-blue-600 rounded shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600'>Accept</button>
                            <button type='button' @click='burnToast(toast.id)' class='inline-flex items-center px-2 py-1 ml-3 text-xs font-semibold text-zinc-900 bg-white rounded shadow-sm ring-1 ring-inset ring-zinc-300 hover:bg-zinc-50'>Decline</button>
                        </div>
                    </div>
                </div>
            `
        ...
        <ul
            ...
            <template x-for="(toast, index) in toasts" :key="toast.id">
                <li
                    ...
                    >
                    <span
                        class="relative flex flex-col items-start shadow-[0_5px_15px_-3px_rgb(0_0_0_/_0.08)] w-full transition-all duration-300 ease-out bg-white dark:bg-zinc-900 dark:border-white/10 border border-zinc-100 sm:rounded-md sm:max-w-xs group"
                        :class="{ 'p-4' : !toast.html, 'p-0' : toast.html }"
                    >
                        <template x-if="!toast.html">
                            <div class="relative">
                                <div class="flex items-center"
                                    :class="{ 'text-green-500' : toast.type=='success', 'text-blue-500' : toast.type=='info', 'text-orange-400' : toast.type=='warning', 'text-red-500' : toast.type=='danger', 'text-zinc-800' : toast.type=='default' }">
                                    ...
                                    <p class="text-[13px] font-medium leading-none text-zinc-800 dark:text-white/70" x-text="toast.message"></p>
                                </div>
                        ...
                        <span
                            ...
                            class="absolute right-0 p-1.5 mr-2.5 text-zinc-400 dark:hover:text-zinc-100 dark:hover:bg-zinc-800 duration-100 ease-in-out rounded-full opacity-0 cursor-pointer hover:bg-zinc-50 hover:text-zinc-500"
