    ...
    <div class="flex w-full flex-col items-center space-y-4 sm:items-end">
        <template x-for="notification in notifications" :key="notification.id">
            <div
                ...
                class="pointer-events-auto w-full max-w-sm overflow-hidden rounded-lg bg-white/75 shadow-lg ring-1 ring-zinc-950/10 backdrop-blur-xl dark:bg-zinc-800/75 dark:ring-inset dark:ring-white/10"
            >
                <div class="p-4">
                    <div class="flex items-start">
                        <div x-show="notification.type === 'error'" class="mr-3 flex-shrink-0">
                        ...
                        <div class="w-0 flex-1">
                            <p x-text="notification.content" class="text-base/6 font-medium text-zinc-950 sm:text-sm/6 dark:text-white"></p>
                        </div>
