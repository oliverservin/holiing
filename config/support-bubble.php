...
return [
     ...
     */
    'mail_to' => 'oliver@oliverservin.com',
    ...
    'classes' => [
        ...
        'button' => 'inline-flex justify-center px-4 py-3 h-10 border-0 bg-purple-500 hover:bg-purple-600 active:bg-purple-600 overflow-hidden rounded-sm text-white leading-none no-underline',
    ],
